...
HUGGINGFACE_TOKENIZER_MODEL_DIR="$DATA_DIR/$LC/huggingface-tokenizer"
HUGGINGFACE_TOKENIZER_MODEL_PATH="$HUGGINGFACE_TOKENIZER_MODEL_DIR/cased"
HUGGINGFACE_TOKENIZER="$SCRIPT_DIR/train_HF_tokenizer.py"

# Disabled until future experiments comparing tokenizers
#WORDPIECE_VOCAB_DIR="$HUGGINGFACE_TOKENIZER_MODEL_PATH"
#WORDPIECE_VOCAB_PATH="$WORDPIECE_VOCAB_DIR/vocab.txt"
...
# ELECTRA
ELECTRA_TFRECORD_DIR_128="$DATA_DIR/$LC/electra-pretrain-tfrecords/seq-128"
ELECTRA_TFRECORD_DIR_512="$DATA_DIR/$LC/electra-pretrain-tfrecords/seq-512"
CREATE_ELECTRA_TFRECORD="$BASE_DIR/electra/build_pretraining_dataset.py"
